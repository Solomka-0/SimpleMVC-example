...
class Article extends \ItForFree\SimpleMVC\mvc\Model
{
    ...
    public function getListByAccess($numRows = 1000000, $startLimit = 0)
    {
        return parent::getList($numRows, 'access_id >= '. $_SESSION['user']['access_id'], startLimit: $startLimit); // TODO: Change the autogenerated stub
    }

    public function getCount()
    {
        $sql = "SELECT COUNT(id) FROM " . $this->tableName . " where access_id >= :access_id;";

        $modelClassName = static::class;

        $st = $this->pdo->prepare($sql);
        $st->bindValue( ":access_id", $_SESSION['user']['access_id'], \PDO::PARAM_INT );
        $st->execute();
